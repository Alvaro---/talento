...
const Author = () => {
    return (
        ...
        <div className='flex md:flex-row-reverse flex-col justify-center items-center m-auto md:w-1/2 border-solid md:p-0 py-10 border-4 border-blue bg-white'>
            ...
            <div className='mx-5 py-0 max-w-sm'>
                <h2 className=' text-xl font-bold mt-5 md:mt-0'>
                    Juan Carlos
                </h2>
                <span className='text-xl font-bold'> Cadavid</span>
                <Image src={Bandera}
                    className='w-10 my-5' />
